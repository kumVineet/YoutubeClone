...
import { StyleSheet, Text, View, ScrollView, TextInput, Image, TouchableOpacity, SafeAreaView, FlatList } from 'react-native';
...
const SearchScreen = () => {
    ...
    const fetchData = () => {
        fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q=${value}&type=video&key=AIzaSyA0J99dPQsGXukBnOYK3ZYoI0NLfH288C0`)
            .then(res => res.json())
            .then(data => {
                console.log(data)
